...
# ClockSync - Adapted from GodotMultiplayerDemo's clock.gd
# Synchronizes time between client and server without autoload
# Used for lag compensation and client prediction
...
# Reference to network manager (set by main scene)
...
func calc_offset(local_time_ms: int,
	...
	if network_manager != null:
		network_manager.ping_in_ms = instantaneous_latency_in_ms
	
	# The formula we are trying to achieve is:
